package com.example.hansungsns.adapter;
...
import com.example.hansungsns.FirebaseHelper;
import com.example.hansungsns.PostInfo;
import com.example.hansungsns.R;
import com.example.hansungsns.activity.PostActivity;
import com.example.hansungsns.activity.WritePostActivity;
import com.example.hansungsns.listener.OnPostListener;
import com.example.hansungsns.view.ReadContentsVIew;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MainViewHolder> {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.modify:
                        myStartActivity(mDataset.get(position));
                        return true;
                    case R.id.delete:
    ...
    private void myStartActivity(PostInfo postInfo) {
